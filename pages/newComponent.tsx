...
export default () => {
    ...
    const [isDrawerOpen, isDrawerOpenChange] = useState(false);
...
<div ref={drawerRef} id="drawer-navigation" className={`${isDrawerOpen ? 'block animate-fade-right animate-once animate-duration-100' : 'hidden '} fixed top-0 left-0 z-50 shadow-2xl h-screen   p-4 overflow-y-auto  bg-white w-80 dark:bg-gray-800`}  aria-labelledby="drawer-navigation-label">
    <h5 id="drawer-navigation-label" className="text-base font-semibold text-gray-500 uppercase dark:text-gray-400">Menu</h5>
    <button onClick={() => {isDrawerOpenChange(!isDrawerOpen)}} type="button" data-drawer-hide="drawer-navigation" aria-controls="drawer-navigation" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" >
...
<div onClick={() => {isDrawerOpenChange(!isDrawerOpen)}} className={`${isDrawerOpen ? 'block' : 'hidden'} w-screen h-screen absolute bg-black opacity-50 z-40`}>

</div>
<div className="text-center z-10 ">
   <button onClick={() => {isDrawerOpenChange(!isDrawerOpen)}}  className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation">
   Show navigation
   </button>
            ...
            <Menu as="div" className="relative inline-block text-left">
                ...
                >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <div className="py-1">
                            {componentList.map((content, index) => {
