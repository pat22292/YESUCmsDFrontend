        ...
        <div >
          {props.product.menus.map((menus, index) => {
            ...
            return <div key={index} >
              ...
              <nav className="py-2 z-50 absolute w-full">
                ...
                <div className="  mx-auto">
                  <div className="hidden w-full absolute  md:grid justify-items-center" id="navbar-default">
                    ...
                    <ul className="flex mt-4 flex-row md:space-x-36 ">
                      ...
                      {props.product.menus[0].content.map((menu, indx) => {
                        ...
                        return (
                          ...
                          indx < props.product.menus[0].content.length / 2 ?
                            ...
                            >
                              <a target="">
                                <li className={`h-16 pt-4`}>{menu.name}
                                </li>
                              </a>
                            </Link>
                      ...
                      {props.product.menus[0].content.map((menu, indx) => {
                        return (
                          indx > props.product.menus[0].content.length / 2 - 1 ?
                  ...
                  {props.product.menus.length != 0 ? <Disclosure as="nav" className="">
                    {({ open }) => (
                      <>
                        ...
                        <div className="flex  flex-1 items-center justify-center sm:items-stretch sm:justify-start md:pt-9">
