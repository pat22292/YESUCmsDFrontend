      ...
      return <div className='md:min-h-screen h-96 md:pt-0  pt-24 z-0'>
            ...
            >
                  {props.block.content.map(content => {
                        return <SwiperSlide className="bg-no-repeat bg-cover bg-center shadow-md grid text-center  place-items-center" style={{ backgroundImage: `url(${content.imgUrl})` }}>{content.title}</SwiperSlide>
                  })}
